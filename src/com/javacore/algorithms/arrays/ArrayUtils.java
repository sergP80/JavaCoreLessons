...
public class ArrayUtils {
    ...
    public static  <T> boolean checkArrayIndex(T[] a, int i)
    {
        if (Objects.isNull(a))
        {
            return false;
    ...
    public static <T> void swapItems(T[] a, int i, int j)
    {
        if (!checkArrayIndex(a, i) || !checkArrayIndex(a, j))
        {
            return;
        }
        T t = a[i];
...
//                    a[i + gap] = tmp;
    ...
    /**
     * Performs random shuffling of array's items
